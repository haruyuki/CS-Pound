...
class TestClass:
    def test_hour_only_strings(self):
        assert (
            get_pound_time(
                "Sorry, the pound is closed at the moment. The pound will open within 6 hours"
            )
            == 21600
        )
        assert (
            get_pound_time(
                "Sorry, the pound is closed at the moment. The pound will open within 5 hours"
            )
            == 18000
        )
        assert (
            get_pound_time(
                "Sorry, the pound is closed at the moment. The pound will open within 4 hours"
            )
            == 14400
        )
        assert (
            get_pound_time(
                "Sorry, the pound is closed at the moment. The pound will open within 3 hours"
            )
            == 10800
        )
        assert (
            get_pound_time(
                "Sorry, the pound is closed at the moment. The pound will open in: 2 hours"
            )
            == 7200
        )
        assert (
            get_pound_time(
                "Sorry, the pound is closed at the moment. The pound will open in: 1 hour"
            )
            == 3600
        )
